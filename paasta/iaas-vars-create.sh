...
source ${SHELL_SCRIPT_PATH}/paasta/vars-create.sh ${CF_STEMCELL} > aws-vars.yml
source ${SHELL_SCRIPT_PATH}/paasta/vars-create.sh ${CF_STEMCELL} > azure-vars.yml
source ${SHELL_SCRIPT_PATH}/paasta/vars-create.sh ${CF_STEMCELL} > gcp-vars.yml
source ${SHELL_SCRIPT_PATH}/paasta/vars-create.sh ${CF_STEMCELL} > openstack-vars.yml
source ${SHELL_SCRIPT_PATH}/paasta/vars-create.sh ${CF_STEMCELL} > vsphere-vars.yml
...
private_ip: "10.244.0.34"		# Proxy IP (Private IP)
...
stemcell_version: "'${CF_STEMCELL}'"		# Stemcell Version
...
haproxy_network: "default"		# HAProxy 네트워크' > bosh-lite-vars.yml
